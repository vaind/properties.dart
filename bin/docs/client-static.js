...
$.json = function() {
  return [$.makeLiteralMap(["name", "properties", "types", [$.makeLiteralMap(["name", "Properties", "kind", "class", "members", [$.makeLiteralMap(["kind", "method", "name", "add"]), $.makeLiteralMap(["kind", "method", "name", "addFromJSON"]), $.makeLiteralMap(["kind", "method", "name", "addFromMap"]), $.makeLiteralMap(["kind", "method", "name", "addFromProperties"]), $.makeLiteralMap(["kind", "method", "name", "contains"]), $.makeLiteralMap(["kind", "method", "name", "everyKey"]), $.makeLiteralMap(["kind", "method", "name", "get"]), $.makeLiteralMap(["kind", "getter", "noparams", true, "name", "keys"]), $.makeLiteralMap(["kind", "constructor", "name", "Properties"]), $.makeLiteralMap(["kind", "constructor", "name", "Properties.fromFile"]), $.makeLiteralMap(["kind", "constructor", "name", "Properties.fromJSON"]), $.makeLiteralMap(["kind", "method", "noparams", true, "name", "reload"]), $.makeLiteralMap(["kind", "method", "name", "toJSON"]), $.makeLiteralMap(["kind", "method", "noparams", true, "name", "toString"]), $.makeLiteralMap(["kind", "getter", "noparams", true, "name", "values"])]])]])];
};

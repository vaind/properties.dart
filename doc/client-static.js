...
$.json = function() {
  return [$.makeLiteralMap(["name", "properties", "types", [$.makeLiteralMap(["name", "AddEvent", "kind", "class", "members", [$.makeLiteralMap(["kind", "constructor", "name", "AddEvent"]), $.makeLiteralMap(["kind", "getter", "noparams", true, "name", "key"]), $.makeLiteralMap(["kind", "method", "noparams", true, "name", "toString"]), $.makeLiteralMap(["kind", "getter", "noparams", true, "name", "value"])]]), $.makeLiteralMap(["name", "BoolEvaluator", "kind", "class", "members", [$.makeLiteralMap(["kind", "method", "name", "evaluate"]), $.makeLiteralMap(["kind", "field", "name", "falses"]), $.makeLiteralMap(["kind", "field", "name", "trues"])]]), $.makeLiteralMap(["name", "Properties", "kind", "class", "members", [$.makeLiteralMap(["kind", "method", "name", "add"]), $.makeLiteralMap(["kind", "field", "name", "ADD_PROPERTY_EVENTNAME"]), $.makeLiteralMap(["kind", "getter", "noparams", true, "name", "boolEvaluator"]), $.makeLiteralMap(["kind", "setter", "name", "boolEvaluator", "link_name", "boolEvaluator="]), $.makeLiteralMap(["kind", "method", "name", "contains"]), $.makeLiteralMap(["kind", "getter", "noparams", true, "name", "enableEvents"]), $.makeLiteralMap(["kind", "setter", "name", "enableEvents", "link_name", "enableEvents="]), $.makeLiteralMap(["kind", "field", "name", "EQUAL"]), $.makeLiteralMap(["kind", "field", "name", "ESCLMARK"]), $.makeLiteralMap(["kind", "field", "name", "eventController"]), $.makeLiteralMap(["kind", "method", "name", "every"]), $.makeLiteralMap(["kind", "method", "name", "get"]), $.makeLiteralMap(["kind", "method", "name", "getBool"]), $.makeLiteralMap(["kind", "method", "name", "getDouble"]), $.makeLiteralMap(["kind", "method", "name", "getInt"]), $.makeLiteralMap(["kind", "method", "name", "getList"]), $.makeLiteralMap(["kind", "field", "name", "HASH"]), $.makeLiteralMap(["kind", "getter", "noparams", true, "name", "keys"]), $.makeLiteralMap(["kind", "method", "name", "merge"]), $.makeLiteralMap(["kind", "method", "name", "mergeJSON"]), $.makeLiteralMap(["kind", "method", "name", "mergeMap"]), $.makeLiteralMap(["kind", "field", "name", "NEWLINE"]), $.makeLiteralMap(["kind", "getter", "noparams", true, "name", "onAdd"]), $.makeLiteralMap(["kind", "getter", "noparams", true, "name", "onUpdate"]), $.makeLiteralMap(["kind", "constructor", "name", "Properties"]), $.makeLiteralMap(["kind", "constructor", "name", "Properties.fromFile"]), $.makeLiteralMap(["kind", "constructor", "name", "Properties.fromJSON"]), $.makeLiteralMap(["kind", "constructor", "name", "Properties.fromMap"]), $.makeLiteralMap(["kind", "method", "noparams", true, "name", "reload"]), $.makeLiteralMap(["kind", "getter", "noparams", true, "name", "size"]), $.makeLiteralMap(["kind", "field", "name", "SLASH"]), $.makeLiteralMap(["kind", "field", "name", "SPACE"]), $.makeLiteralMap(["kind", "method", "name", "toJSON"]), $.makeLiteralMap(["kind", "method", "noparams", true, "name", "toString"]), $.makeLiteralMap(["kind", "field", "name", "UPDATE_PROPERTY_EVENTNAME"]), $.makeLiteralMap(["kind", "getter", "noparams", true, "name", "values"])]]), $.makeLiteralMap(["name", "PropertiesEvent", "kind", "class", "members", [$.makeLiteralMap(["kind", "constructor", "name", "PropertiesEvent"]), $.makeLiteralMap(["kind", "getter", "noparams", true, "name", "type"])], "args", "T"]), $.makeLiteralMap(["name", "UpdateEvent", "kind", "class", "members", [$.makeLiteralMap(["kind", "getter", "noparams", true, "name", "key"]), $.makeLiteralMap(["kind", "getter", "noparams", true, "name", "newValue"]), $.makeLiteralMap(["kind", "getter", "noparams", true, "name", "oldValue"]), $.makeLiteralMap(["kind", "method", "noparams", true, "name", "toString"]), $.makeLiteralMap(["kind", "constructor", "name", "UpdateEvent"])]])]])];
};
